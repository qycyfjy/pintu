# modified from https://github.com/foobar167/junkyard/blob/master/manual_image_annotation1/polygon/gui_canvas.py
...
class CanvasImage:
    ...
    def __init__(self, placeholder, image: Image.Image, width, height):
        ...
        self.canvas.bind(
            "<ButtonPress-3>", self.__move_from
        )  # remember canvas position
        self.canvas.bind(
            "<B3-Motion>", self.__move_to
        ...
        Image.MAX_IMAGE_PIXELS = (
            MAX_IMAGE_PIXELS  # suppress DecompressionBombError for big image
        )
        ...
        self.__pyramid = (
            [self.smaller()] if self.__huge else [self.original_image.copy()]
        )
    ...
    def smaller(self):
        ...
        while i < self.imheight:
            ...
            self.__image.close()
            self.__image = self.original_image.copy()  # reopen / reset image
